...
import controllers.ui.util.JsfUtil;
import controllers.ui.util.JsfUtil.PersistAction;
import persistence.dao.WebMaCiudadesFacadeDAO;
...
public class WebMaCiudadesController implements Serializable {
    ...
    @EJB
    private persistence.dao.WebMaCiudadesFacadeDAO ejbFacade;
